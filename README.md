...
Pacboost is not an official tool. If pacboost can't build a package, you should first check if `makepkg` can successfully build the package. If it can't, then you should report the issue to the maintainer. Otherwise, it is likely an issue with pacboost and should be reported here.
